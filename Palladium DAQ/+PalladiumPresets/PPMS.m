function PPMS(palladium, gui)
%PPMS - Palladium preset function for when interfacing with a remote computer controlling a PPMS cryostat.


%Add the PPMS and configure
ppms = palladium.AddInstrument("PPMS", Name="PPMS");
