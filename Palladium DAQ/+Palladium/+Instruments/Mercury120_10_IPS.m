classdef Mercury120_10_IPS < Palladium.Core.Instrument
    ...
    %via contacting OI directly for a scanned copy. Command syntax is
    %different to the newer 120s.
    ...
    methods (Access = public)
        ...
        function status = GetStatus(this)
            if this.SimulationMode
                ...
                %Note that there are small differences between this model
                %and the newer 120 models in the Mercury120_IPS file
            ...
            switch(displayAndSpeedStatusString)
                case('0')
                    status.DisplayAndSpeedStatus = "Amps - Immediate - Fast";
                case('1')
                    status.DisplayAndSpeedStatus = "Tesla - Immediate - Fast";
                case('2')
                    status.DisplayAndSpeedStatus = "Amps - Sweep - Fast";
                case('3')
                    status.DisplayAndSpeedStatus = "Tesla - Sweep - Fast";
                case('4')
                    status.DisplayAndSpeedStatus = "Amps - Immediate - Train";
                case('5')
                    status.DisplayAndSpeedStatus = "Tesla - Immediate - Train";
                case('6')
                    status.DisplayAndSpeedStatus = "Amps - Sweep - Train";
                case('7')
        ...
        function SetRampRate_AmpsMin(this, currentRampRate_Amin)
            ...
            %Send the command
            commandStr = "S" + this.NumToIntText(currentRampRate_Amin);
        ...
        function SetTargetCurrent(this, current_A)
            ...
            %Send the command
            commandStr = "I" + this.NumToIntText(current_A);
            this.QueryString(commandStr);
        ...
        function SetTargetField(this, field_T)
            ...
            if this.SimulationMode
                disp("Field setpoint set to " + this.NumToIntText(field_T) + " T");
                return;
            end
